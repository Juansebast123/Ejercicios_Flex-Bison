...
#line 17 "ejemplo1-5.y"
                    { printf("= %d\n", yyvsp[-1]); }
#line 1076 "ejemplo1-5.tab.c"
    break;

  case 4: /* exp: factor  */
#line 19 "ejemplo1-5.y"
            { yyval = yyvsp[0]; }
#line 1082 "ejemplo1-5.tab.c"
    break;

  case 5: /* exp: exp ADD factor  */
#line 20 "ejemplo1-5.y"
                  { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1088 "ejemplo1-5.tab.c"
    break;

  case 6: /* exp: exp SUB factor  */
#line 21 "ejemplo1-5.y"
                  { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1094 "ejemplo1-5.tab.c"
    break;

  case 7: /* factor: term  */
#line 23 "ejemplo1-5.y"
             { yyval = yyvsp[0]; }
#line 1100 "ejemplo1-5.tab.c"
    break;

  case 8: /* factor: factor MUL term  */
#line 24 "ejemplo1-5.y"
                   { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1106 "ejemplo1-5.tab.c"
    break;

  case 9: /* factor: factor DIV term  */
#line 25 "ejemplo1-5.y"
                   { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1112 "ejemplo1-5.tab.c"
    break;

  case 10: /* term: NUMBER  */
#line 27 "ejemplo1-5.y"
             { yyval = yyvsp[0]; }
#line 1118 "ejemplo1-5.tab.c"
    break;

  case 11: /* term: ABS term  */
#line 28 "ejemplo1-5.y"
            { yyval = yyvsp[0] >= 0? yyvsp[0] : - yyvsp[0]; }
#line 1124 "ejemplo1-5.tab.c"
    break;


#line 1128 "ejemplo1-5.tab.c"
